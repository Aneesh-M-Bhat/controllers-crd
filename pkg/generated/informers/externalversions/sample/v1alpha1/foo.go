...
import (
	...
	versioned "crds-controller/pkg/generated/clientset/versioned"
	internalinterfaces "crds-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "crds-controller/pkg/generated/listers/sample/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SampleV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SampleV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&samplev1alpha1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplev1alpha1.Foo{}, f.defaultInformer)
}
